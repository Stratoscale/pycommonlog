...
def _findCallerPyAgnostic(*args, **kwargs):
    ...
    stack_frame = logging.currentframe()
    while hasattr(stack_frame, "f_code"):
        frame_code = stack_frame.f_code
        ...
        if sys.version_info[0] == 2:
            return (filename, stack_frame.f_lineno, frame_code.co_name)
        return (filename, stack_frame.f_lineno, frame_code.co_name, None)
    if sys.version_info[0] == 2:
